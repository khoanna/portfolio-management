            ...
            <div className="w-full md:w-1/2 text-gray-300 leading-relaxed text-sm md:text-base">
                <div>
                    ...
                    <div>
                        ...
                        động crypto trong cùng một ứng dụng đơn giản, dễ dùng. Bạn sẽ luôn biết
                        số tiền của mình đang ở đâu, còn lại bao nhiêu và có thể tiết kiệm thế
                        nào cho những mục tiêu quan trọng.
                    </div>
                </div>
            </div>
        </section>
